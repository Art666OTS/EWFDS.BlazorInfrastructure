...
/// <summary>
/// Service that validates an access identifier (supplied via the X-Access-Id header)
...
public interface IAccessControlValidationService
{
    ...
    /// </summary>
    /// <param name="accessId">The access identifier from the X-Access-Id header (a GUID token).</param>
